...
namespace PerfectButler.UI
{
    ...
    {
        public static GameCompletePopup Instance { get; private set; }
        ...
        [Header("SFX")]
        [SerializeField] private AudioClip gameCompleteSound; // 게임 클리어 소리
        ...
        private void Start()
        {
            ...
            // 게임 완료 이벤트 구독
            CatStats.OnGameComplete += ShowGameCompletePopup;
        }
        ...
        public void ShowGameCompletePopup()
        {
            if (popupPanel == null)
            {
                Debug.LogWarning("GameCompletePopup: popupPanel이 null입니다!");
                return;
            }
            ...
            // 게임 클리어 소리 재생
            if (SFXManager.Instance != null && gameCompleteSound != null)
            {
                SFXManager.Instance.PlaySound(gameCompleteSound);
            }
        ...
        private void OnConfirmButtonClicked()
        {
            ...
            // 저장 데이터 삭제 (새 게임 시작을 위해)
            CatStats.ClearSaveData();
            Debug.Log("게임 클리어: 저장 데이터 삭제 완료");
